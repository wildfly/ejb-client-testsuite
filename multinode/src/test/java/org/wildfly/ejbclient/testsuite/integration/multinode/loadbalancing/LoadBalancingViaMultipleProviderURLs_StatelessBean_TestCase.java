...
@RunAsClient
public class LoadBalancingViaMultipleProviderURLs_StatelessBean_TestCase {
    ...
    private static Logger logger = Logger.getLogger(LoadBalancingViaMultipleProviderURLs_StatelessBean_TestCase.class.getName());

    public static JavaArchive createDeployment() {
        final JavaArchive jar = ShrinkWrap.create(JavaArchive.class, "load-balancing.jar");
    ...
    /**
     * PROVIDER_URL contains two URLs, both are valid. Stateless bean invocations
     * should load balance between these two nodes.
     */
    @Test
    public void loadBalancingWhenTwoProviderUrlsAreProvided() throws Exception {
        ...
        final WhereAmI bean = (WhereAmI)ejbCtx
                .lookup("ejb:/load-balancing/" + WhereAmIStateless.class.getSimpleName() + "!"
