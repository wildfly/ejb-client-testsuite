...
@RunAsClient
public class ClientInvokingTwoClustersStatelessBeanTestCase {
    ...
    private static Logger logger = Logger.getLogger(ClientInvokingTwoClustersStatelessBeanTestCase.class.getName());
    ...
    public void testInvokingTwoClustersAlternately() throws Exception {
        ...
        try {
            final WhereAmI beanInCluster1 = (WhereAmI) ejbCtx_cluster1
                    .lookup("ejb:/" + DEPLOYMENT_NAME + "/" + WhereAmIStateless.class.getSimpleName() + "!"
