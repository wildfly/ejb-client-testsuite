...
@RunAsClient
public class FailoverViaMultipleProviderURLsStatelessBeanTestCase {
    ...
    @Test
    public void node1WorksFirst_ThenRunNode2AndKillNode1() throws Exception {
        ContainerHelpers.stopContainers(containerController, CLUSTER1_NODE2.nodeName);
    ...
    @Test
    public void node2WorksFirst_ThenRunNode1AndKillNode2() throws Exception {
        ContainerHelpers.stopContainers(containerController, CLUSTER1_NODE1.nodeName);
