...
@RunAsClient
public class FailoverViaSingleProviderURLStatefulBeanTestCase {
	...
	private static Logger logger = Logger.getLogger(FailoverViaSingleProviderURLStatefulBeanTestCase.class.getName());
	 ...
	 * URLs to that server, it should be able to discover the other node (after it is started).
	 */
	@Test
