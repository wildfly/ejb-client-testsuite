...
import org.wildfly.ejbclient.testsuite.integration.basic.echo.async.echobean.EchoBeanAsyncStateless;
...
@RunAsClient
public class AsyncStatelessEchoTestCase extends AsyncEchoAbstractTestCase {
    ...
    protected Class<? extends EchoBeanAsyncRemote> getBeanClass() {
        return EchoBeanAsyncStateless.class;
    }
