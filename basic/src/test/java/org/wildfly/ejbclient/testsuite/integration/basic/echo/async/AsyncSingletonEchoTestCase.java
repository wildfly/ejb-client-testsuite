...
import org.wildfly.ejbclient.testsuite.integration.basic.echo.async.echobean.EchoBeanAsyncSingleton;
...
@RunAsClient
public class AsyncSingletonEchoTestCase extends AsyncEchoAbstractTestCase {
    ...
    protected Class<? extends EchoBeanAsyncRemote> getBeanClass() {
        return EchoBeanAsyncSingleton.class;
    }
